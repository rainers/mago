...
namespace MagoEE
{
    ...
    HRESULT TypeEnv::NewFunction( Type* returnType, Type* thisPtrType, ParameterList* params, uint8_t callConv, int varArgs, Type*& type )
    {
        type = new TypeFunction( params, returnType, thisPtrType, callConv, varArgs );
        type->AddRef();
        return S_OK;
    }
