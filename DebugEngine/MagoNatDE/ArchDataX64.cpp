...
namespace
{
    ...
    {
        { L"RAX", RegX64_RAX, 64, 0, 0 },
        { L"RBX", RegX64_RBX, 64, 0, 0 },
        { L"RCX", RegX64_RCX, 64, 0, 0 },
        { L"RDX", RegX64_RDX, 64, 0, 0 },
        { L"RSI", RegX64_RSI, 64, 0, 0 },
        { L"RDI", RegX64_RDI, 64, 0, 0 },
        { L"R8",  RegX64_R8,  64, 0, 0 },
        { L"R9",  RegX64_R9,  64, 0, 0 },
        { L"R10", RegX64_R10, 64, 0, 0 },
        { L"R11", RegX64_R11, 64, 0, 0 },
        { L"R12", RegX64_R12, 64, 0, 0 },
        { L"R13", RegX64_R13, 64, 0, 0 },
        { L"R14", RegX64_R14, 64, 0, 0 },
        { L"R15", RegX64_R15, 64, 0, 0 },
        { L"RIP", RegX64_RIP, 64, 0, 0 },
        { L"RSP", RegX64_RSP, 64, 0, 0 },
        { L"RBP", RegX64_RBP, 64, 0, 0 },
